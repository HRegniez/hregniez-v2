...
<CardContainer className="inter-var">
      <CardBody className="bg-background relative group/card dark:hover:shadow-2xl dark:hover:shadow-primary/10 dark:bg-background dark:border-primary/20 border-primary/10 w-[20rem] h-auto rounded-xl p-6 border">
        <CardItem
          translateZ="300"
